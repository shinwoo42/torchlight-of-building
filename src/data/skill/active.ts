...
export const ActiveSkills = [
  ...
  },
  {
    ...
    description: [
      ...
      "Pummel:\nDeals 438% Weapon Attack Damage.\nWhen consuming Demolisher Charge, 70% additional damage for the Pummel per channeled stacks.",
  ...
  },
  {
    ...
    description: [
      "Casts the skill and spreads Freezing Air within a certain area around the caster, dealing Spell Cold Damage equal to 72% Base Damage.\nCasts the skill and gains Euphoria: The next 5 other skills deal 81% additional damage. After casting another skill, this bonus becomes -15% for 6s. Stacks up to 5 time(s). Multiple stacks of the skill effect multiplies.",
  ...
  },
  {
    ...
    description: [
      "Casts the skill and gains the defensive effect: Additionally -8.8% Physical Damage and Fire Damage taken for 5s.\nWhile the skill lasts, generates three Frost Shields around the caster, dealing 80-121 Spell Cold Damage.",
  ...
  },
  {
    ...
    description: [
      "Casts the skill and generates a Frost Terra at the target spot, dealing 485 Persistent Cold Damage every second.\nTerra Charge and the enemy's Frozen status grant additional damage to the skill.",
      "Frost Terra:\nFrost Terra lasts for 3s\nDeals damage for 2s, dealing 485 Persistent Cold Damage every second\nThis skill deals 25% additional damage to Frozen enemies.\nFor every 1 Terra Charge consumed, the skill 26% additional damage\nDamage Over Time statuses inflicted by the skill can't be spread (excludes Ailments)",
  ...
  },
  {
    ...
    description: [
      "Casts the skill and deals 430-430 Spell Erosion Damage to the target enemy and generates a Haunting Terra to follow the enemy around.\nHaunting Terra deals 430-430 Spell Erosion Damage to the enemies within it every 0.65s.\nTerra Charge grants additional damage to the skill.",
      "Haunting Abomination:\nDeals 430-430 Spell Erosion Damage.",
      "Haunting Terra:\nHaunting Terra lasts 4s.\nDeals 430-430 Spell Erosion Damage to enemies within it every 0.65s. Bonuses and additional bonuses for Cast Speed are also applied to the Interval.\nHaunting Terra expands gradually over its duration, gaining +20% additional Skill Area per second.",
  ...
  },
  {
    ...
    description: [
      "Casts the skill and fires 1 Ice Lance forward, dealing 302% Weapon Attack Damage on hit.\nThe Ice Lance explodes behind the enemy on hit, dealing 151% Weapon Attack Damage.\nOn hit, this skill inflicts Frostbite and 100 Frostbite Rating. CD for the same enemy: 10s.\nAll of the skill's Physical Damage will be converted to Cold Damage.",
      "Icy Lances:\nDeals 302% Weapon Attack Damage.\nThe skill fires 1 Projectile in its base state.",
  ...
  },
  {
    ...
    description: [
      "Launches a Sweep Slash to attack the fan-shaped area in front, dealing 266% Weapon Attack Damage on hit.\nThis skill is affected by Steep Strike chance and may be cast in Steep Strike form. When it launches a Steep Strike, it generates 1 Icy Blade, dealing 266% Weapon Attack Damage on hit. Upon hitting a Frozen enemy with this skill, gains a Steep Strike attempt. Causes an explosion when Steep Strike hits a Frozen enemy, dealing 400% Weapon Attack Damage. Multiple explosions and Steep Strikes can hit the same enemy.\nAll of the skill's Physical Damage will be converted to Cold Damage.",
      "Sweep Slash:\nDeals 266% Weapon Attack Damage.",
      "Steep Strike:\nDeals 266% Weapon Attack Damage.\n+100% chance to grant 1 Steep Strike attempt(s) when this skill hits a Frozen enemy. Interval: 0.01s",
      "Explosion:\nDeals 400% Weapon Attack Damage.\nExplosions are considered a part of Steep Strike.\nMultiple explosions and Steep Strikes can hit the same enemy.",
      "Converts 100% of the skill's Physical Damage to Cold Damage\nThis skill +20% Steep Strike chance.",
  ...
  },
  {
    ...
    description: [
      "Casts the skill and lets out a Warcry: Weakens nearby enemies. For each enemy affected, -2% additional damage taken, up to -70% additional damage taken, for 3s.\nCasts the skill and gains restoration: Restores 40 Life within 4s. This effect is not affected by Warcry Effects.",
  ...
  },
  {
    ...
    description: [
      "Channels the skill and fires 1 Fire Beam forward, dealing 55-103 Spell Fire Damage to the enemy at the end of the beam on hit.\nAt max channeled stacks, loses all channeled stacks and denotates explosion at the end of the beam, dealing 166-308 Hit Fire Damage.",
      "Fire Beam:\nDeals 55-103 Spell Fire Damage.",
      "Fire Explosion:\nDeals 166-308 Spell Fire Damage.",
      "Channels up to 5 stacks.",
