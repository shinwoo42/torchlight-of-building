...
export const MagnificentSupportSkills = [
  ...
  },
  {
    ...
    description: [
      ...
      "-20% additional Projectile Damage for the supported skill\nWhen the supported skill's explosions hit, they inflict 1 stack of debuff that lasts for 5 s and stacks up to 8 time(s)\nFor each stack of debuff, +3% base radius for explosions generated by the supported skill",
      "For every stack of debuff, +(10.5–11.0)% additional Hit Damage dealt to the enemy by the supported skill's explosions",
    ],
  ...
  },
  {
    ...
    tags: ["Cold"],
    description: [
      "Supports Frost Spike.\nThis skill can only be installed in the third Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill\n+20 Max Frostbite Rating for 2 s after casting the supported skill",
      "+20 Max Frostbite Rating for 2 s after casting the supported skill",
  ...
  },
  {
    ...
    description: [
      ...
      "0.1% additional Detonation Skill Area for every 1% Multistrike chance of the Sentry deployed by the supported skill",
      "被辅助技能放置的哨卫每 1% 连续攻击几率，引爆额外 (0.28–0.30)% 击中伤害，上限 200 层",
    ],
  ...
  },
  {
    ...
    description: [
      "Supports Ice Focus.\nThis skill can only be installed in the third Support Skill Slot of each Active Skill.\n+20% additional damage for the supported skill",
      "The bonus and additional bonus to Cast Speed are also applied to the Interval of Glacial Spikes generated by the supported skill, up to 150%",
    ],
  ...
  },
  {
    ...
    tags: ["Lightning"],
    description: [
      "Supports Summon Grim Phantom.\nThis skill can only be installed in the third Support Skill Slot of each Active Skill.\n+20% additional damage for Minions summoned by the supported skill\nFor every 4 time(s) a Minion summoned by the supported skill casts High Energy Beam, 1.5% Skill Area for this skill for every 1 Command the character has, stacking up to 50 time(s)",
      "For every 4 time(s) a Minion summoned by the supported skill casts High Energy Beam, 1.5% Skill Area for this skill for every 1 Command the character has, stacking up to 50 time(s)",
      "For every 4 time(s) a Minion summoned by the supported skill casts High Energy Beam, +(2.3–2.5)% additional damage for this skill for every 1 Command the character has, stacking up to 50 time(s)",
    ],
