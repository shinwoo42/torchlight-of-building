...
export const Legendaries: readonly Legendary[] = [
  ...
  },
  {
    ...
    normalAffixes: [
      ...
      "Upon inflicting damage, +(2-2.5)% additional damage taken (multiplies) for each stack of Wilt the enemy has",
    ...
    corruptionAffixes: [
      "+(300-400) Max Life",
      "+(28-35)% Attack and Cast Speed",
      "Upon inflicting damage, +(2.6-3)% additional damage taken (multiplies) for each stack of Wilt the enemy has",
  ...
  },
  {
    ...
    normalAffixes: [
      ...
      "When Strength is greater than Dexterity, gains (20-24)% - (48-55)% of the added Flat Damage's Base Trauma Damage",
      "When Intelligence is greater than Strength, gains 5% - 6% of the added Flat Damage's Base Wilt Damage",
      "When Dexterity is greater than Intelligence, gains (15-18)% - (30-32)% of the added Flat Damage's Base Ignite Damage",
    ],
    corruptionAffixes: [
      "+(9-12)% all stats",
      "+(40-45)% Ailment Damage Enhancement",
      "When Strength is greater than Dexterity, gains (25-30)% - (60-66)% of the added Flat Damage's Base Trauma Damage",
      "When Intelligence is greater than Strength, gains 6% - 7% of the added Flat Damage's Base Wilt Damage",
      "When Dexterity is greater than Intelligence, gains (20-22)% - (35-38)% of the added Flat Damage's Base Ignite Damage",
    ],
    equipmentSlot: "Trinket",
    equipmentType: "Belt",
  },
    ...
    normalAffixes: [
      ...
      "+(40-60)% Ailment Damage Enhancement",
      {
        ...
        choices: [
          ...
          "Gains (100-110)% - (190-210)% of the added Flat Damage's Base Ignite Damage",
    ...
    corruptionAffixes: [
      ...
      "+(65-75)% Ailment Damage Enhancement",
      {
        ...
        choices: [
          ...
          "Gains (130-140)% - (230-250)% of the added Flat Damage's Base Ignite Damage",
  ...
  },
  {
    ...
    normalAffixes: [
      ...
      "Gains 8% - 8% of the added Flat Damage's Base Ailment Damage when you have at least 10 stack(s) of Agility Blessing",
    ],
    corruptionAffixes: [
      "+(300-400)% Gear Physical Damage",
      "+(40-50)% gear Attack Speed",
      "+20% additional Ailment Damage when you have at least 8 stack(s) of Agility Blessing",
      "Gains 10% - 10% of the added Flat Damage's Base Ailment Damage when you have at least 10 stack(s) of Agility Blessing",
    ],
    equipmentSlot: "Two-Handed",
  ...
  },
  {
    ...
    normalAffixes: [
      "+(170-238) gear Energy Shield",
      "+(16-22)% Cold Resistance",
      "Reaps 0.3 s of Damage Over Time when dealing Damage Over Time. The effect has a 6 s Restoration Duration against the same target",
    ...
    corruptionAffixes: [
      ...
      "Reaps 0.4 s of Damage Over Time when dealing Damage Over Time. The effect has a 6 s Restoration Duration against the same target",
  ...
  },
  {
    ...
    normalAffixes: [
      ...
      "每释放一个不同的战吼，额外 +6% 战吼技能的效果，额外 +(14-16)% 战吼技能冷却回复速度，持续 8 秒（叠乘）",
    ...
    corruptionAffixes: [
      ...
      "+1% additional duration for the current Warcry for each enemy affected by Warcry\n+(25-30)% Warcry Effect",
      "每释放一个不同的战吼，额外 +9% 战吼技能的效果，额外 +(21-24)% 战吼技能冷却回复速度，持续 8 秒（叠乘）",
  ...
  },
  {
    ...
    normalAffixes: [
      ...
      "Reaps (1.3-1.5) s of Damage Over Time from Nearby enemies within 10 m that have full Affliction. The effect has a 1 s Restoration Duration against the same target",
    ...
    corruptionAffixes: [
      ...
      "Reaps (1.5-1.8) s of Damage Over Time from Nearby enemies within (12-15) m that have full Affliction. The effect has a 1 s Restoration Duration against the same target",
  ...
  },
  {
    ...
    normalAffixes: [
      ...
      "Reaps 0.25 s of Damage Over Time from Nearby enemies within 10 m that have full Affliction. The effect has a (2-5) s Restoration Duration against the same target",
      "+(5-6)% Fire and Cold Resistance",
    ],
    corruptionAffixes: [
      "+(80-110)% Damage Over Time",
      "+(10-15)% Skill Effect Duration",
      "Reaps 0.5 s of Damage Over Time from Nearby enemies within 10 m that have full Affliction. The effect has a (2-5) s Restoration Duration against the same target",
      "+(6-10)% Fire and Cold Resistance",
    ],
    equipmentSlot: "Trinket",
    equipmentType: "Ring",
  ...
  },
  {
    ...
    normalAffixes: [
      ...
      "+1 Max Mana",
      "+(80-115) to All Stats",
      "+1% Elemental Resistance per 40 stats, up to 0%",
    ],
    corruptionAffixes: [
      "+(100-120) Max Life",
      "+(100-120) Max Energy Shield",
      "+(100-120) Max Mana",
      "+(130-150) to All Stats",
      "+1% Elemental Resistance per 35 stats, up to 0%",
    ],
    equipmentSlot: "Chest Armor",
    equipmentType: "Chest Armor (STR)",
  },
