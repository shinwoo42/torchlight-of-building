...
export const TWO_HANDED_AXE_PREFIX_AFFIXES: readonly BaseGearAffix[] = [
  ...
  },
  {
    ...
    tier: "2",
    craftableAffix:
      "Reaps (0.18-0.24) s of Trauma Damage when dealing Damage Over Time. The effect has a 1 s cooldown against the same target",
  },
  {
    equipmentSlot: "Two-Handed",
    equipmentType: "Two-Handed Axe",
    ...
    tier: "3",
    craftableAffix:
      "Reaps 0.16 s of Trauma Damage when dealing Damage Over Time. The effect has a 1 s cooldown against the same target",
  },
  {
    equipmentSlot: "Two-Handed",
    equipmentType: "Two-Handed Axe",
    ...
    tier: "4",
    craftableAffix:
      "Reaps 0.14 s of Trauma Damage when dealing Damage Over Time. The effect has a 1 s cooldown against the same target",
  },
  {
    equipmentSlot: "Two-Handed",
    equipmentType: "Two-Handed Axe",
