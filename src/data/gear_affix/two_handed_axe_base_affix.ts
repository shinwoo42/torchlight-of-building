...
export const TWO_HANDED_AXE_BASE_AFFIX_AFFIXES: readonly BaseGearAffix[] = [
  {
  ...
  },
  {
    ...
    craftingPool: '',
    tier: '1',
    craftableAffix: '+(12-16)% additional damage against Traumatized enemies',
  },
  {
    equipmentSlot: 'Two-Handed',
    equipmentType: 'Two-Handed Axe',
  ...
  },
  {
    ...
    craftingPool: '',
    tier: '1',
    craftableAffix: '+(12-18)% additional Steep Strike Damage',
  },
  {
    equipmentSlot: 'Two-Handed',
    equipmentType: 'Two-Handed Axe',
